function carrega_entregas(tipo){
 ...
 skullcorres='<div class="list media-list">'
			  +'<ul style="padding-left: 5px !important;">'
				 +'<li class="item-content skeleton-text skeleton-effect-blink">'
					...
					+'<div class="item-inner">'
					  +'<div class="item-title-row">'
							+'<div class="item-title">FIRST CONTROL SISTEMA INTELIGENTE LTDA</div>'
					  +'</div>'
					  +'<div class="item-text">00-00-0000 00:00</div>'
					+'</div>'
				 +'</li>'
 				 +'<li class="item-content skeleton-text skeleton-effect-blink">'
					+'<div class="item-media">'
					...
					+'<div class="item-inner">'
					  +'<div class="item-title-row">'
							+'<div class="item-title">FIRST CONTROL </div>'
					  +'</div>'
					  +'<div class="item-text">00-00-0000 00:00</div>'
					+'</div>'
				 +'</li>'
 				 +'<li class="item-content skeleton-text skeleton-effect-blink">'
					...
					+'<div class="item-inner">'
					  +'<div class="item-title-row">'
							+'<div class="item-title">FIRST CONTROL SISTEMA  LTDA</div>'
					  +'</div>'
					  +'<div class="item-text">00-00-0000 00:00</div>'
					+'</div>'
				 +'</li>'
				 ...
				 +'</li>'
 				 +'<li class="item-content skeleton-text skeleton-effect-blink">'
					...
					+'<div class="item-inner">'
					  +'<div class="item-title-row">'
							+'<div class="item-title">FIRST CONTROL SISTEMA INTELIGENTE </div>'
					  +'</div>'
					  +'<div class="item-text">00-00-0000 00:00</div>'
					+'</div>'
				 +'</li>'
 				 +'<li class="item-content skeleton-text skeleton-effect-blink">'
					...
					+'<div class="item-inner">'
					  +'<div class="item-title-row">'
							+'<div class="item-title">FIRST INTELIGENTE LTDA</div>'
					  +'</div>'
					  +'<div class="item-text">00-00-0000 00:00</div>'
					+'</div>'
				 +'</li>'
 				 +'<li class="item-content skeleton-text skeleton-effect-blink">'
					...
					+'<div class="item-inner">'
					  +'<div class="item-title-row">'
							+'<div class="item-title">FIRST CONTROL SISTEMA INT</div>'
					  +'</div>'
					  +'<div class="item-text">00-00-0000 00:00</div>'
					+'</div>'
				 +'</li>'
...
$("#main_correspondencia" ).append(skullcorres);
	...
	$.ajax({
		...
		crossDomain: true,
		beforeSend : function() { /*$("#skull_correspondencia" ).css("display", "block");*/  },
		complete   : function() { /*$( "#skull_correspondencia" ).css("display", "none");*/ },
...
//				dado += '</div>';
			...
			if(cont == 0 && offset == 0 ){
			  dados = "<div align='center' style='margin-top: 50%; width:100%'><h4>Ops! Nenhum registro encontrado aqui :(</h4><br>"
...
{		$( "#main_correspondencia" ).html('');
 ...
 skullcorres='<div class="list media-list">'
	...
	$.ajax({
		...
		crossDomain: true,
		beforeSend : function() { /*$("#main_correspondencia" ).html(skullcorres);*/ },
		complete   : function() { /*$( "#main_correspondencia" ).html(dados);*/ },
...
function status_encomenda_filtro()
{
	...
	$(".smart-select-page .navbar .sliding .left .back .").attr('id','slc_status_correspondencia');
