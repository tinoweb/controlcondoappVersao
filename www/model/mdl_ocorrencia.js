...
function carrega_ocorrencia(tipo){
	"use strict";
//	app.controler_pull("comunicados");
	...
	$.ajax({
        ...
        beforeSend : function() { },
        complete   : function() { },
        data       : 'id_condominio='+$( "#DADOS #ID_CONDOMINIO" ).val()+'&pg='+parseInt(pg)+'&titulo='+$("#busca_ocorrencia").val()+'&id_morador='+$( "#DADOS #ID_MORADOR" ).val(),
        dataType   : 'json',
